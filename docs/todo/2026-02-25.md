...
## 🔜 다음 할 일
- ⬜ Phase 7: 모의투자 활성화 (#20+21) — 설정 활성화 + 3단 라디오 UI
- ⬜ Phase 10: Soul 자동 진화 크론 (B안, 텔레그램+웹)
- ⬜ Phase 11: 분석 품질 대시보드 (Chart.js 시간 추이)
- ⬜ Phase 12: 부서 간 협업 로그
- ⬜ Phase 13: 테스트 (test_spawn_filter.py, test_rework.py)

---

## 💬 대표님 논의사항 (2/24에서 이관, 미구현)
- ⬜ #2: 검수 시작 로그 — 전 직원 작업 "시작" 시 로그 기록
- ⬜ #3~5: 통신로그 UX/UI 통일, 색상 구분, 발신자 표기 통일
- ⬜ #6: 기밀문서탭 CPO 누락
- ⬜ #20: 모의투자 매매 0건 — auto_execute + enable_mock 활성화 필요
- ⬜ #21: 매매모드 프론트 UI — 3단 라디오
- ⬜ P2-2: 교신로그 탭 전환 버그
- ⬜ P2-4~P2-12 (9건)
- ⬜ 노션 DB 속성명 불일치 수정
