...
| `web/kis_client.py` | **KIS 해외 모의투자 매도 TR_ID 재수정** — VTTT1001U → VTTT1006U (KIS 공식 GitHub 기준: T→V 변환 규칙) |
...
| 해외 모의투자 매도 TR_ID 혼동 | API 포털 기본정보란에 `VTTT1001U`로 잘못 표기, KIS 공식 GitHub은 T→V 규칙으로 `VTTT1006U` 사용 | ✅ VTTT1006U로 재수정 |
...
| 파일 | 내용 |
|------|------|
| `docs/kis-api-reference.md` | KIS 공식 GitHub + API 포털 기준 전체 TR_ID, 파라미터, 엔드포인트 참고 문서 |
