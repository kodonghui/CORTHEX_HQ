...
### 버그 1: 처장 지시서 `max_tokens` TypeError (arm_server.py)

| 구분 | 내용 |
|------|------|
| **위치** | `web/arm_server.py` — `_chain_create_delegation_broadcast()` 내부 `_get_delegation()` |
...
| 파일 | 변경 내용 |
|------|-----------|
| `web/arm_server.py` | 줄 1738: `max_tokens=2048` 파라미터 제거 |
