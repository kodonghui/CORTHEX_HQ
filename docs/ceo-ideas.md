...
## 💡 #005: AI 인플루언서 — "나노바나나로 AI 인플루언서 만들어서 인스타 활동시키면?"

**날짜**: 2026-02-22 (야간, 인스타 보다가 발견)
**분류**: 신규 사업 아이디어 / 마케팅 전략
**영향**: 리트마스터 홍보 채널 + 수익화 신규 파이프라인

### 대화

> **CEO**: 야야야 나노바나나로 예쁘고 잘생긴 ai 인플루언서 사진 하나 만들고 veo로 영상 만들어서 나 대신 인스타에서 활동하게 할 수 있는 방법이 있네..????? 자기전에 인스타보다가 발견함;;
> **CEO**: 젠스파크 구독해있거든 내가? 거기 이미지 만드는거 무제한이라서 거기서 바나나 무한으로 돌려서 ai 초안 만들수 있는데 그것도 메모해놔줘

### Claude 분석

조사 결과 AI 인플루언서는 이미 검증된 사업 모델:
- Aitana Lopez (스페인): 1인 에이전시가 만든 AI 인플루언서, 월 1.1만$ 수익
- 로지 (한국): 2022년 매출 40억원 (이후 하락 — 스토리텔링 부재가 원인)
- CORTHEX에서 월 2.9만원으로 운영 가능 (기존 인프라 거의 그대로 활용)

### CEO 추가 기여: 젠스파크 무제한 이미지 활용
- 대표님이 젠스파크 구독 중 → 이미지 생성 무제한
- 캐릭터 초안을 젠스파크에서 무한 생성 → 마음에 드는 것 선택 → 나노바나나 Pro로 일관성 확보
- **비용 $0으로 초안 작업 가능** — 이건 대표님만의 자원 활용 전략

### 결과

AI 인플루언서 프로젝트를 2/23 TODO에 독립 섹션으로 추가.
상세 조사 보고서: `CORTHEX_수석실/AI_인플루언서_조사보고서.md`
