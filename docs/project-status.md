...
## 2026-03-01 — Noir Commander 팔레트 대개편 (빌드 #742~#743)

### 배포 완료
| 빌드 | 내용 |
|------|------|
| #742 | PR #718 — Noir Commander 팔레트 v1: 칠흑 #0a0a0a + 골드 amber-400 |
| #743 | PR #720 — Noir Commander 배경 밝기 조정: #0a0a0a → #181818 |

### 현재 팔레트 (Noir Commander)
- 배경: `#181818` (다크 그레이)
- 악센트: `#fbbf24` (amber-400, 골드)
- 카드: `#222222` / 패널: `#1c1c1c`
- body glow: 미세한 골드 radial-gradient (오른쪽 위)
