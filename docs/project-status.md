...
- **날짜**: 2026-02-15
- **버전**: `0.07.002`
- **작업 브랜치**: claude/phase1b-all-data-to-sqlite
- **작업 내용**: Phase 1B — 모든 웹 데이터 SQLite 영구 저장. 프리셋/예약/워크플로우/메모리/피드백/예산/에이전트 설정/품질검수/소울 등 웹 UI에서 저장하는 모든 데이터가 DB에 영구 저장. 재배포/재시작해도 데이터 유지
