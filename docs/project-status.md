...
## ✅ 완료 — 설계실 탭 + 뼈대 플로우차트 (2026-02-25)

> 전체 시스템 시각화 & Mermaid 편집기. 탭: 더보기 → 설계실

- 뼈대 다이어그램 5종: 최상위구조/조직도/명령흐름/매매흐름/탭맵/데이터흐름
- 3분할 UI: 파일목록 | VS Code 스타일 에디터 | 실시간 Mermaid 미리보기
- 마우스 휠 줌 · 드래그 패닝 · Ctrl+S 저장 · SVG 내보내기 · 템플릿 4종
- CLAUDE.md — "최신 레퍼런스 분석 후 착수" 규칙 추가
