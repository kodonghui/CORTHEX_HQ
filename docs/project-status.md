...
- **날짜**: 2026-03-01
- **버전**: `4.00.004`
- **빌드**: #736 배포완료 / PR #712 대기중 (v5 로그인+3본부+기밀문서탭+CLI라우팅)
- **서버**: https://corthex-hq.com

## 2026-03-01 — UX 대개편 Phase 2 + v5 구현 (빌드 #733~#736, PR #712)
...
- CLAUDE_API_KEY_SISTER GitHub Secrets 등록

### 배포 방침
이제부터 대표님 확인 후 배포 (자동 배포 없음)
