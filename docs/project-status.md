...
## 🔥 다음 대규모 작업: 에이전트 협업 구조 대 개편 (2026-02-17 논의 완료)

> **이 섹션은 2026-02-17 CEO와의 긴 논의 결과를 기록한 것입니다. 다음 세션에서 반드시 먼저 읽을 것.**
...
1. **🔥 에이전트 협업 구조 대 개편** — 위 "논의 결론" 섹션 참고. 새 세션에서 팀 에이전트(FE+BE+QA)로 구현
2. **키움증권 Open API+ 연동** — 모의투자 → 실거래 전환 (API 키 발급 필요)
