...
- **날짜**: 2026-02-15
- **버전**: `0.06.002`
- **작업 브랜치**: claude/add-all-missing-api-endpoints
- **작업 내용**: 누락된 API 44개 전부 구현 — UI의 모든 저장/삭제/추가 버튼이 작동하도록. 기존 24개 → 64개 엔드포인트
...
1. **29명 에이전트 소울(성격) 설정** — `docs/TODO-에이전트-설정.md` 참고
