...
**P1.5 — CLAUDE.md 다이어트 시 반영할 CEO 요청 (2026-02-20)**
- "논의하자" 키워드 시 → 자동으로 **아이디어/옵션/추천** 제시하도록 규칙 명시 (이미 비슷한 규칙 있으나 더 명확하게)
- status.md를 **수시로** 기록하게 규칙 추가 (특히 논의 내용 → 컴팩 후 까먹지 않게)
- CLAUDE.md 전체 다이어트 (500줄 → 핵심만, CEO 논의 후 실행)
- 버그 발견 시 bug-reports.md 적극 기록
- 업데이트/CLAUDE.md 변경 시 docs/updates/ 기록
