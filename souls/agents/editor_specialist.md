...
| 다른 에이전트와 소통 | `cross_agent_protocol action=request, to_agent="cpo_manager", task="편집 완료 보고"` |

**도구**: doc_converter, report_generator, newsletter_builder, chart_generator, pdf_parser, cross_agent_protocol (에이전트 간 작업 요청/인계)
